...
export default function SplashScreen() {
  ...
  const screens = [
    {
      animation: require("../assets/images/Movie Camera.json"),
      title: "Your Gateway to Cinema",
      subtitle: "Explore, follow, and enjoy the movies you love",
    },
    {
      animation: require("../assets/images/Loading 40 _ Paperplane.json"),
      title: "Find Your Film",
      subtitle: "Browse by genre, cast, and everything in between",
    },
    {
      animation: require("../assets/images/love.json"),
      title: "Saved Picks",
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#9ed7f4ff", alignItems: "center", justifyContent: "center", paddingHorizontal: 25 },
  skipBtn: { position: "absolute", top: 50, right: 20, backgroundColor: "rgba(19, 18, 18, 0.05)", paddingVertical: 6, paddingHorizontal: 12, borderRadius: 20 },
  skipText: { fontSize: 15, color: "#150202ff", fontWeight: "600" },
  animation: { width: 340, height: 340 },
  title: { fontSize: 28, fontWeight: "800", marginTop: 20, color: "#111", textAlign: "center" },
  subtitle: { fontSize: 16, color: "#210c4dff", textAlign: "center", marginTop: 10, lineHeight: 22 },
